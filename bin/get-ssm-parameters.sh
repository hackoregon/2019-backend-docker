...
NAMESPACE="$NAMESPACE" # future-proofing this script for subsequent or past containers
PROJECT_CANONICAL_NAME="$PROJECT_CANONICAL_NAME" # must be set to each project's "Final naming convention" from here https://github.com/hackoregon/civic-devops/issues/1
